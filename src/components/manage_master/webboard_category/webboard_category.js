...
class Webboard_category extends Component {
  componentDidMount() {
    this.props.getWebboardCategory();
    document.title = APP_TITLE + " manage webboard category";
    this.debounceSearch = _.debounce(
      this.props.getWebboardCategoryByKeyword,
      500
    );
  }
                  ...
                  MySwal.fire({
                    ...
                    if (result.value) {
                      this.props.history.push(
                        `/master/edit/webboard_category/category=${item.category}`
                      );
                    }
                  });
                }}
              ...
              <button
                onClick={() => {
                  MySwal.fire({
                    ...
                    if (result.value) {
                      this.props.deleteWebboardCategory(item.category);
                    }
                  });
                }}
                type="button"
              ...
              <div className="col-12">
                <div className="card">
                  <div className="card-header">
                    <h2 className="card-title">Webboard category table</h2>
                  </div>
                  {/* /.card-header */}
                  ...
                  <div className="card-body">
                    <div className="input-group input-group-sm">
                      ...
                      <span className="input-group-append">
                        <Link
                          to="/master/create/webboard_category"
                          style={{
                            float: "right",
                            marginLeft: 5,
                            borderRadius: 10,
...
export default connect(mapStateToProps, mapDispatchToProps)(Webboard_category);
