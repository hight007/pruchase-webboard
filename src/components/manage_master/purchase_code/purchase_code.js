...
class Purchase_code extends Component {
  componentDidMount() {
    this.props.getPurchaseCode();
    document.title = APP_TITLE + " manage_purchaseCode";
    this.debounceSearch = _.debounce(this.props.getPurchaseCodeByKeyword, 500);
  }
              ...
              <button
                onClick={() => {
                  Swal.fire({
                    ...
                    if (result.value) {
                      this.props.deletePurchaseCode(item.divisionCode);
                    }
                  });
                }}
                type="button"
              ...
              <div className="col-12">
                <div className="card">
                  <div className="card-header">
                    <h2 className="card-title">purchase code table</h2>
                  </div>
                  {/* /.card-header */}
...
export default connect(mapStateToProps, mapDispatchToProps)(Purchase_code);
